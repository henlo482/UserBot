...
if len(argv) not in (1, 3, 4):
    ...
    if Config.TG_BOT_USER_NAME_BF_HER is not None:
        ...
        LOGS.info("Initialisation finished successfully without errors.")
...
LOGS.info("Yay!! your PineApple UserBot is officially working.!!!")
LOGS.info(
    "Congratulations, now type .alive to see message if bot is live\
